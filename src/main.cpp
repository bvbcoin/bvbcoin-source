...
unsigned int nStakeMinAge = 9 * 60; // 9 minutes
unsigned int nModifierInterval = 24 * 60 * 60; // time to elapse before new modifier is computed

int nCoinbaseMaturity = 1; //11: (1+10)
...
const string strMessageMagic = "BVBCoin Signed Message:\n";
